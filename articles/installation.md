...
the same way. Alternatively, the development version of the package can
be installed by running one of the following lines:
...
For those who prefer not to use GitHub, the package can also be
installed with one of the following two additional options:
